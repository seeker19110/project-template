...
| `templates/` | — | Bản mẫu sạch: `GOAL.template.md`, `FEATURE-SPEC.template.md`, `FEATURE-MAP.template.md`, `CONVENTIONS.template.md`, `COMPLETION-PLAN.template.md` | Pha 1/3 của `/completion` |
